...
- number value(unit-less value) 1.0-1.2 inital value, ** relative to their font size**.  **best method** for setting line-height as line-heights will then always scale with the relevant font size
