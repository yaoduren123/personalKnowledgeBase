...
- it is safe to assume that **headings can have less relative line-height than paragrahs of text**. For example: heading 1.2 normal content 1.5
- WCAG 2.0: line spacing is at least space and a half  within paragraph
- 
